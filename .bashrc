...
#                         MAKE
alias utst="make MAKE_TARGET=for_utest"
alias mkl="make clean && make > log"
alias sst="cd ${NG_ROOT}; svn stat -q | sort"
alias build="ng_make >& build.log &"
alias gdb_f="/opt/fp5/oct_sdks/CAVIUMSDK_1.7.2-244-FP1/OCTEON-SDK/tools/bin/mips64-octeon-linux-gnu-gdb"
